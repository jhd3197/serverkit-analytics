import { formatDate, formatNumber, formatTime } from 'serverkit-sdk';
...
export const formatInt = (n) => formatNumber(Number(n ?? 0));
...
export const formatDay = (iso) => {
    ...
    return formatDate(d, { parts: { month: 'short', day: 'numeric' } });
};
...
export const formatClock = (iso) => {
    ...
    return formatTime(d, { parts: { hour: '2-digit', minute: '2-digit', second: '2-digit' } });
};
